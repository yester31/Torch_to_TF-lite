...
for device in device_lib.list_local_devices():
    ...
    print(f"available device :: {device_name}: {device_type}")
...
# def representative_dataset():
#     for _ in range(100):
#       data = np.random.rand(1, 3, 244, 244)
...
# float 32
# device = "cpu:0" 일 때
# 100 iteration time (tensorflow lite): 6.133277177810669 [sec] 44.5MB
# resnet18 max index : 388 , value : 13.804119110107422, class name : giant panda panda panda bear coon bear Ailuropoda melanoleuca
# device = "gpu:0" 일 때
# 100 iteration time (tensorflow lite): 6.326269865036011 [sec] 44.5MB
# resnet18 max index : 388 , value : 13.804119110107422, class name : giant panda panda panda bear coon bear Ailuropoda melanoleuca

# float 16
# device = "cpu:0" 일 때
# 100 iteration time (tensorflow lite): 6.2975475788116455 [sec] 22.3MB
# resnet18 max index : 388 , value : 13.798822402954102, class name : giant panda panda panda bear coon bear Ailuropoda melanoleuca
# device = "gpu:0" 일 때
# 100 iteration time (tensorflow lite): 6.649981260299683 [sec] 22.3MB
# resnet18 max index : 388 , value : 13.798822402954102, class name : giant panda panda panda bear coon bear Ailuropoda melanoleuca

# int 8
# device = "cpu:0" 일 때
# 100 iteration time (tensorflow lite): 1072.7681787014008 [sec] 11.2MB
# resnet18 max index : 388 , value : 14.05152702331543, class name : giant panda panda panda bear coon bear Ailuropoda melanoleuca
# device = "gpu:0" 일 때
# 100 iteration time (tensorflow lite): 1037.098114490509 [sec] 11.2MB
# resnet18 max index : 388 , value : 14.05152702331543, class name : giant panda panda panda bear coon bear Ailuropoda melanoleuca