...
# 전처리 및 추론 연산 함수
def infer_tf(img, net, half, device):
...
def main():
    ...
    out = infer_tf(img, tf_model, half, device)
...
# Tensorflow model(torch to tf using onnx) 2021-12-06
# device = "cpu:0" 일 때
# 100 iteration time : 3.7480337619781494 [sec]
# device = "gpu:0" 일 때
# 100 iteration time : 0.8322277069091797 [sec]